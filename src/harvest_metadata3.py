...
class MetadataHarvester(object):
    ...
    """
    def __init__(self, baseURL, records, outputDir, hProtocol, srcfmt=None, username=None, pw=None):
        ...
        if hProtocol == 'OAI-PMH':
            ...
            if dom is not None:
                if "dif" in self.srcfmt:
                    ...
                    raise ValueError("Metadata format not supported yet.")
            else:
